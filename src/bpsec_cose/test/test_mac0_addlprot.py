...
KEY = SymmetricKey(
    k=bytes.fromhex('3a5c74e32ab4558a99581ec3a816576812aabe895db04494cda25b711d7b5ed4077466e677860648412f1bf8c91d0624'),
    optional_params={
...
class TestExample(BaseTest):
    ...
    _ADDL_PROT = {
        headers.KID.identifier: KEY.kid,
    }
    _ADDL_PROT_ENC = cbor2.dumps(_ADDL_PROT)
    ...
    def test(self):
        ...
        # Additional header maps
        self._logger.info('Additional Protected: %s', cbor2diag(self._ADDL_PROT_ENC))
        self._logger.info('Encoded: %s', self._ADDL_PROT_ENC.hex())
